...
from hetmarl.algorithms.mat.algorithm.ma_transformer import MultiAgentTransformer
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, n_agent_types, device=torch.device("cpu")):
        ...
        if self.algorithm_name in ["amat", "mat", "mat_dec"]:
            from hetmarl.algorithms.mat.algorithm.ma_transformer import MultiAgentTransformer as MAT
        ...
        elif "mancp" in self.algorithm_name:
            self.transformer = MAT(self.share_obs_dim, self.obs_dim, self.act_dim, num_agents, n_agent_types,
                                n_block=args.n_block, n_embd=args.n_embd, n_hidden=args.recurrent_hidden_size, n_embd_vit=args.n_embd_vit, n_head=args.n_head,
                                encode_state=args.encode_state, device=device,
                                action_type=self.action_type, dec_actor=args.dec_actor,
                                share_actor=args.share_actor)
    ...
    def act(self, cent_obs, obs, masks, rnn_states_actor, available_actions=None, deterministic=True):
        """
