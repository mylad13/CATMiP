...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='amat', choices=["mancp", "amat", "mat", "mat_dec", "mat_encoder", "mat_decoder", "mat_gru","rmappo", "mappo", "ft_rrt", "ft_nearest", "ft_apf", "ft_utility", "ft_voronoi"])
    ...
    parser.add_argument("--user_name", type=str, default='mylad',help="[for wandb usage], to specify user's name for simply collecting training data.")
    parser.add_argument("--wandb_name", type=str, default='mylad',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--recurrent_hidden_size", type=int, default=64,
                        help="Dimension of hidden layers for recurrent networks")
    parser.add_argument("--use_recurrent_encoder", action='store_true',
                        default=False, help="Whether to use a recurrent encoder")
    parser.add_argument("--use_recurrent_decoder", action='store_true',
                        default=False, help="Whether to use a recurrent decoder")
    ...
    parser.add_argument("--n_embd_vit", type=int, default=48) #embedding size for vision transformer
    ...
    parser.add_argument("--embed_hidden_size", type=int, default=64)
    ...
    # observations
    parser.add_argument("--trajectory_forget_rate", type=float, default=0.8)
    parser.add_argument("--goal_history_decay", type=float, default=0.8)
    parser.add_argument("--path_prediction_decay", type=float, default=0.8)
    parser.add_argument("--detect_traces", action='store_true', default=False)
    
    # Actions
    parser.add_argument('--action_size', type=int, default=5, help="action size")
    parser.add_argument('--use_action_masking', action='store_true', default=False, help="use available actions mask")

    # heterogeneous agents settings
    parser.add_argument("--n_agent_types", type=int, default=2)
    parser.add_argument("--agent_types_list", nargs='+', type=int)

    # communication settings
    parser.add_argument("--use_full_comm", action='store_true', default=False,
                        help="use full communication")
    parser.add_argument("--use_partial_comm", action='store_true', default=False,
                        help="use partial communication")
    parser.add_argument("--com_sigma", type=float, default=5, help="standard deviation of the communication probabilty")
