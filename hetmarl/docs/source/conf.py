...
latex_documents = [
    (master_doc, 'hetmarl.tex', 'onpolicy Documentation',
     'Chao Yu', 'manual'),
]
...
man_pages = [
    (master_doc, 'onpolicy', 'onpolicy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'onpolicy', 'onpolicy Documentation',
     author, 'onpolicy', 'One line description of project.',
     'Miscellaneous'),
]
