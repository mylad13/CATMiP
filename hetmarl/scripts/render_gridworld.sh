...
do
    CUDA_VISIBLE_DEVICES=0 python render/render_gridworld.py\
      ...
      --num_agents ${num_agents} --num_obstacles ${num_obstacles} --seed 4 --n_rollout_threads 1 \
      --max_steps 500 --agent_view_size 7 --local_step_num 10 \
      --astar_cost_mode normal --model_dir "/home/farjadnm/CATMiP/hetmarl/scripts/results/GridWorld/MiniGrid-SearchAndRescue-v0/amat/MAT_for_target_finding/wandb/run-20250425_123554-9sabosmx/files" \
      --grid_size 16 --wandb_name "mylad" \
      --user_name "mylad"  \
      ...
      --n_agent_types 2 --agent_types_list 0 1 1 --use_energy_penalty --use_agent_obstacle \
      --use_full_comm --com_sigma 2  --asynch \
      --use_render --render_episodes 30 \
      #removed  --save_gifs --block_doors --block_chance 0.6  --use_time_penalty --use_intrinsic_reward  --detect_traces
done
