...
import numpy as np
from matsar.utils.multi_discrete import MultiDiscrete
...
class GridWorldEnv(object):
    def __init__(self, args):
        ...
        register(
            ...
            entry_point='matsar.envs.gridworld.gym_minigrid.envs:SearchAndRescueEnv',
        ...
        if args.algorithm_name == 'amat' or args.algorithm_name == 'mat' or args.algorithm_name == 'mat_dec':
            ...
            global_observation_space['local_agent_map'] = gym.spaces.Box(low=0, high=1, shape=(4, action_size_length, action_size_length), dtype='float')
        else:
