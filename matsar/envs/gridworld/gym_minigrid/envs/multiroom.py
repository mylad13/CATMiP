...
'''register(
    ...
    entry_point='matsar.envs.gridworld.gym_minigrid.envs:MultiRoomEnvN2S4'
)

register(
    id='MiniGrid-MultiRoom-N4-S5-v0',
    entry_point='matsar.envs.gridworld.gym_minigrid.envs:MultiRoomEnvN4S5'
)

register(
    id='MiniGrid-MultiRoom-N6-v0',
    entry_point='matsar.envs.gridworld.gym_minigrid.envs:MultiRoomEnvN6'
)'''
