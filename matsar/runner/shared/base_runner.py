...
from matsar.utils.shared_buffer import SharedReplayBuffer
...
class Runner(object):
    def __init__(self, config):
        ...
        if "mat" in self.algorithm_name:
            from matsar.algorithms.mat.mat_trainer import MATTrainer as TrainAlgo
            from matsar.algorithms.mat.algorithm.transformer_policy import TransformerPolicy as Policy
        else:
